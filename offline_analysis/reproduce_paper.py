...
if __name__ == "__main__":
    ...
    print("F =", def_eng_res["ANOVA"].statistic, "p =", def_eng_res["ANOVA"].pvalue)
    ...
    print("F =", indef_eng_res["ANOVA"].statistic, "p =", indef_eng_res["ANOVA"].pvalue)
    ...
    print("F =", def_spa_res["ANOVA"].statistic, "p =", def_spa_res["ANOVA"].pvalue)
    ...
    print("F =", indef_spa_res["ANOVA"].statistic, "p =", indef_spa_res["ANOVA"].pvalue)
    print("Signifcant T-tests:", indef_spa_res["significant_t-tests"])
    print("")

    obj_pron_res = viz.gen_word_boxplots(['lo', 'los', 'las', 'la'], "PRON", "spa", "imgs/pronouns/lo_los_las_la_PRON_boxplot.png")
    print("Writing 3rd person object pronouns (lo/los/la/las) boxplot to imgs/pronouns/lo_los_las_la_PRON_boxplot.png")
    print("F =", obj_pron_res["ANOVA"].statistic, "p =", obj_pron_res["ANOVA"].pvalue)
    ...
    print("Writing clitics (lo/los/la/las) boxplot to imgs/clitics/clitics.png")
    print("F =", clitics_res["ANOVA"].statistic, "p =", clitics_res["ANOVA"].pvalue)
    ...
    print("Writing clitics and 3rd person pronouns (lo/los/la/las) boxplot to imgs/clitics/clitics_w_pronouns.png")
    print("F =", clitics_w_pronouns_res["ANOVA"].statistic, "p =", clitics_w_pronouns_res["ANOVA"].pvalue)
    #print("Signifcant T-tests:", clitics_res["significant_t-tests"])